...
$("#report-issue").attr(
  "href",
  "https://github.com/endbasic/endbasic/issues/new?body=" + template
);
...
function fitTerminal() {
  ...
  terminal.height =
    document.documentElement.clientHeight - footer[0].clientHeight - 30;
}
fitTerminal();
