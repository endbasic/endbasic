...
Copy-Item .\SDL2-2.32.10\lib\x64\*.lib libs
[void](New-Item -Force -Type Directory dlls)
Copy-Item .\SDL2-2.32.10\lib\x64\*.dll dlls
Copy-Item .\SDL2-2.32.10\lib\x64\*.txt dlls

Remove-Item -Recurse -Force .\SDL2-2.32.10
